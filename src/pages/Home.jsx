...
// function defenition for get all data
  ...
  registerData&&<Alert variant='success' onClose={()=>setregisterData("")}dismissible>
   {registerData.fname.toUpperCase()}registered successfully...........
    ...
    <div className='container'>
      ...
      <div className='search-all d-flex aligh-items-center'>

        <div className='seach d-flex aligh-items-center mt-4'>

          <span className='fw-bolder'>Search</span>
          <input type="text" onChange={e=>setSearch(e.target.value)} placeholder='Seach By Employee Name' className='form-control ms-3' style={{width:'400px'}}/>
